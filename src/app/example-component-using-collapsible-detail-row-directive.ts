...
export class LinguistsListComponent extends UnifyComponent implements OnInit, AfterViewInit {
	...
	onToggleSubrow(cdkDetailRow: CollapsibleDetailRowDirective, row: IDBUser): void {
